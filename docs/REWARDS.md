...
- `font-weight` (limited to `400` / `500` / `600`, the Barlow weights bundled by the app)
- `font-style` (`normal` | `italic`)
- `font-family` **only** among:
  - `Barlow, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif` (charter default; same stack as the rest of the UI)
