...
GitHub Actions run on pushes to `master` and on pull requests touching the matching component:
...
- `Build Mod (Windows)` (`.github/workflows/build-mod.yml`): cargo test --lib + release DLL artifact.
