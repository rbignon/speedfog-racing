...
See docs/specs (wrong-save guard): regressions are always plausible
(backup restores are legitimate); a forward jump is implausible when it
outruns wall-clock time since the last accepted report.
"""
