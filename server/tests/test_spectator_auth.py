...
class TestBuildSeedInfo:
    """Test SeedInfo construction — always includes graph_json."""
    ...
    def test_includes_graph(self, sample_graph_json: dict):
        """graph_json is always included with correct v3 stats."""
