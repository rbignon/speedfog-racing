<script lang="ts">
  ...
  // A pseudo skin (None, Random) stands for no fixed aura, so there is
  // nothing to show: the Twitch avatar stays.
  let useSkinAsAvatar = $derived(phantomSkin !== null && !phantomSkin.pseudo);
