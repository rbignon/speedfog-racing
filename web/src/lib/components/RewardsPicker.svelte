<script lang="ts">
  ...
  let selectedTemplate = $derived(
    inventory.unlocked_templates.find((t) => t.id === selectedTemplateId) ??
      null,
  );

  let selectedBadge = $derived(
    selectedBadgeId
      ? (inventory.held_badges.find((b) => b.id === selectedBadgeId) ?? null)
      : null,
  );
...
<div class="rewards-picker">
  ...
  >
    ...
    {/if}
    <span class="preview-name" style={nameStyleFor(selectedTemplate)}
      >{displayName}</span
    >
    {#if selectedBadge}
      <img
  ...
  <div class="subsection">
    ...
    <p class="subsection-description">
      Choose a badge to display next to your name in races and on the
      leaderboard.
    </p>
  ...
  <div class="subsection">
    ...
    <p class="subsection-description">
      Choose a visual style for your username on the website and in-game
      leaderboards.
    </p>
    <ul class="template-list">
      {#each inventory.unlocked_templates as t (t.id)}
        {@const isActive =
          (inventory.equipped_name_template_id ?? "default") === t.id}
  ...
  <div class="subsection">
    ...
    <p class="subsection-description">
      Pick the colored aura applied to your character in-game. The change
      applies at your next race.
    </p>
    <div class="skin-grid">
      {#each phantomSkins.unlocked as s (s.id)}
        ...
        >
          <img
            src="/phantom_skins/{s.screenshot_filename}"
            alt=""
            class="skin-tile-img"
          />
