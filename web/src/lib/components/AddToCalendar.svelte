    ...
    <div class="dropdown">
      <button class="dropdown-item" onclick={openGoogleCalendar}>
        <svg viewBox="0 0 20 20" fill="currentColor" width="16" height="16">
          <path
            d="M10 2a8 8 0 100 16 8 8 0 000-16zm1 4a1 1 0 10-2 0v4a1 1 0 00.293.707l2.5 2.5a1 1 0 101.414-1.414L11 9.586V6z"
          />
        </svg>
        Google Calendar
      </button>
      ...
      <button class="dropdown-item" onclick={downloadIcs}>
        <svg viewBox="0 0 20 20" fill="currentColor" width="16" height="16">
          <path
            fill-rule="evenodd"
            d="M6 2a2 2 0 00-2 2v12a2 2 0 002 2h8a2 2 0 002-2V7.414A2 2 0 0015.414 6L12 2.586A2 2 0 0010.586 2H6zm2 10a1 1 0 100 2h4a1 1 0 100-2H8zm0-3a1 1 0 100 2h4a1 1 0 100-2H8z"
            clip-rule="evenodd"
          />
        </svg>
        Outlook
