 ...
 * upgrade level (rows are spaced at multiples of 100). Unknown ids fall back
 * to `Weapon #<base>` so a future DLC the server has not yet been refreshed
 * for still renders something useful.
 */
